 ...
 * 
 */
@WebServiceClient(name = "MovieService", targetNamespace = "http://services.moviesoap.mycompany.com/", wsdlLocation = "http://localhost:8080/MovieSOAP/MovieService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MOVIESERVICE_QNAME = new QName("http://services.moviesoap.mycompany.com/", "MovieService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/MovieSOAP/MovieService?wsdl");
    ...
    public MovieService getMovieServicePort() {
        return super.getPort(new QName("http://services.moviesoap.mycompany.com/", "MovieServicePort"), MovieService.class);
    }
    ...
    public MovieService getMovieServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.moviesoap.mycompany.com/", "MovieServicePort"), MovieService.class, features);
    }
